...
#      define CAF_TEST_EXPORT __attribute__((visibility("default")))
#    else
...
#    define LIBCAF_TEST_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef LIBCAF_TEST_DEPRECATED
#  define LIBCAF_TEST_DEPRECATED __attribute__ ((__deprecated__))
#endif
